                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('treatments.update', $treatment->id) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3 row">
                                                <label for="name" class="col-md-2 col-form-label">Project Name</label>
                                                <div class="col-10 col-md-6">
                                                    <input class="form-control" type="text" id="name" name="name" value="{{ old('name', $treatment->name) }}">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label for="thumbnail" class="col-md-2 col-form-label">Project Thumbnail</label>
                                                <div class="col-10 col-md-6">
                                            ...
                                            <div class="mb-3 row">
                                                <label class="col-md-2 col-form-label">Current Project Thumbnail</label>
                                                <div class="col-10 col-md-6">
