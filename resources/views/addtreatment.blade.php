                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-10 col-md-6">
                                                <input class="form-control" type="text" id="example-text-input" name="name" value="{{ old('name') }}" required>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-url-input" class="col-md-2 col-form-label">Project Thumbnail</label>
                                            <div class="col-10 col-md-6">
